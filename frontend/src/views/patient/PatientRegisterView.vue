...
async function handleRegister() {
  if (!phone.value.trim() || !password.value.trim() || !fullName.value.trim()) {
    authStore.error = 'Vui lòng nhập đầy đủ thông tin'
    return
  }
  const success = await authStore.register(phone.value.trim(), password.value, fullName.value.trim())
      ...
      <div class="form-wrapper">
        ...
        <form @submit.prevent="handleRegister" class="login-form">
          <div class="form-group">
            ...
            <input v-model="fullName" type="text" class="form-input" placeholder="Nhập họ và tên" autocomplete="name"/>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              <input v-model="password" :type="showPassword ? 'text' : 'password'" class="form-input" placeholder="Tạo mật khẩu" autocomplete="new-password"/>
        ...
        <p class="register-prompt">
          Đã có tài khoản? 
          <RouterLink :to="{ name: 'patient-login' }" class="register-link">Đăng nhập</RouterLink>
        </p>
      </div>
    </div>
  </div>
