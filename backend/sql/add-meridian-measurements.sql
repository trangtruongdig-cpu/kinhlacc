...
CREATE TABLE IF NOT EXISTS meridian_measurements (
  ...
  -- 12 kinh lạc, mỗi kinh có giá trị tay trái + tay phải (đơn vị: mV, dữ liệu thực là FLOAT)
  tieutruong_trai  NUMERIC(6,2),   -- Tiểu Trường (trái)
  tieutruong_phai  NUMERIC(6,2),   -- Tiểu Trường (phải)
  tam_trai         NUMERIC(6,2),   -- Tâm (trái)
  tam_phai         NUMERIC(6,2),   -- Tâm (phải)
  tamtieu_trai     NUMERIC(6,2),   -- Tam Tiêu (trái)
  tamtieu_phai     NUMERIC(6,2),   -- Tam Tiêu (phải)
  tambao_trai      NUMERIC(6,2),   -- Tâm Bào (trái)
  tambao_phai      NUMERIC(6,2),   -- Tâm Bào (phải)
  daitrang_trai    NUMERIC(6,2),   -- Đại Trường (trái)
  daitrang_phai    NUMERIC(6,2),   -- Đại Trường (phải)
  phe_trai         NUMERIC(6,2),   -- Phế (trái)
  phe_phai         NUMERIC(6,2),   -- Phế (phải)
  bangquang_trai   NUMERIC(6,2),   -- Bàng Quang (trái)
  bangquang_phai   NUMERIC(6,2),   -- Bàng Quang (phải)
  than_trai        NUMERIC(6,2),   -- Thận (trái)
  than_phai        NUMERIC(6,2),   -- Thận (phải)
  dam_trai         NUMERIC(6,2),   -- Đảm (trái)
  dam_phai         NUMERIC(6,2),   -- Đảm (phải)
  vi_trai          NUMERIC(6,2),   -- Vị (trái)
  vi_phai          NUMERIC(6,2),   -- Vị (phải)
  can_trai         NUMERIC(6,2),   -- Can (trái)
  can_phai         NUMERIC(6,2),   -- Can (phải)
  ty_trai          NUMERIC(6,2),   -- Tỳ (trái)
  ty_phai          NUMERIC(6,2),   -- Tỳ (phải)

  -- Metadata
  measured_by_admin_id UUID REFERENCES admins(id) ON DELETE SET NULL,
