...
@Controller('ton-thuong-tac-nhan')
export class TonThuongTacNhanRouter {
  constructor(private readonly service: TonThuongTacNhanService) {}
  ...
  async update(
    ...
    @Body() dto: UpdateTonThuongTacNhanDto,
  ) {
